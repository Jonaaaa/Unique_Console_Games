...
|---|---|---|---|---|
| Klax | 1990 | **Include** (`Ported`) | Under the arcade rule the first home release counts, and Atari owns the property outright — which is why it appears in *Atari 50*. | Home versions landed on Lynx, Genesis, NES, Amiga and others within months of each other, so no single platform is cleanly the debut. Arguably a multi-platform sim-ship. |
...
- **ComLynx multiplayer titles (~10).** Games designed around daisy-chained consoles.
  Structurally unportable, and the reason several entries above are stranded rather
