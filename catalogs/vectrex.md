...
| **Coverage** | **Complete** for notable titles; 28 cartridges total. |

## ⚠ The only vector-display console ever sold

The Vectrex has a stranding cause nothing else in this repo shares: it contains its own
**built-in vector monitor**. It draws lines directly with an electron beam rather than
...
have since passed through Hasbro, which — unusually — **released them for
...
| Star Trek: The Motion Picture | 1982 | GCE | GCE | Space combat | 1 | No | **Stranded** | — | A Paramount film licence on a dead vector console — as locked as anything in this repo. |
...
- Homebrew is out of scope, though it is unusually large here — the Vectrex's library
