...
| | |
|---|---|
| **Platforms** | Bandai Super Vision 8000 (1979), Casio PV-1000 (1983), Gakken TV Boy (1983) |
| **Lifespan** | 1979 – 1984; all Japan-only, all commercial failures |
...
Giving each its own file would produce three near-identical pages with three or four
rows each and the same cause repeated.

They are grouped because they share one stranding profile completely: **Japan-only,
tiny libraries, no surviving games division, no reissue of any kind, ever.** The
`Platform` column below distinguishes them.

The Bandai Super Vision 8000 matters historically: it was **the first Japanese console
with interchangeable ROM cartridges and a CPU**, predating the Famicom by four years.
...
|---|---|---|---|---|
| Grouping three platforms together | 1979–83 | **One file** | Under fifteen titles each, identical stranding cause, identical market outcome. Three separate files would repeat the same page three times with no added information. | Every other platform in this repo gets its own file regardless of size — the [RCA Studio II](rca-studio-ii.md) has eleven titles and stands alone. Consistency argues for splitting these if the repo ever documents them more deeply. Recorded so the decision is visible rather than assumed. |
...
- The grouping decision is recorded in [Contested](#contested) rather than assumed.
