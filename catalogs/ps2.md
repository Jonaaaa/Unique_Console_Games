...
| **Coverage** | **Deliberately partial.** ~50 marquee and structurally interesting titles verified individually out of ~4,400. This file makes no claim to completeness — see [Coverage gaps](#coverage-gaps). |
...
|---|---|---|---|---|
| TimeSplitters 2 | 2002 | **Include** (`Stranded`) | It has never been sold on another platform. Its appearance inside *Homefront: The Revolution* is an easter egg in someone else's game, not a release. | The full game is genuinely playable, in full, on PS4/Xbox One/PC via that unlockable — so it is arguably available elsewhere and should be `Ported`. |
