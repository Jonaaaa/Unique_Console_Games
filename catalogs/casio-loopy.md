# Casio Loopy — Unique Games Catalogue

| | |
|---|---|
| **Platform** | Casio Loopy (1995) — Japan only |
| **Lifespan** | Oct 1995 – 1998; sales never disclosed, believed well under 100,000 |
...
The Loopy was marketed exclusively to teenage girls in Japan and had a **thermal sticker
printer inside the console**. Its games exist largely to generate printable stickers of
your characters and screenshots, and a companion accessory let you capture video from a
TV and print that too.

Every title is `Stranded`, and the printer is why: the software's output medium is
physical adhesive paper. There is nothing to port the printing to.
...
**Why the Loopy strands games.** Three walls at once: the printer peripheral is
integral, every title carries a licensed shōjo manga or anime property, and Casio left
games entirely. `Ported` count of **zero**, and this is the least plausible reissue
...
- 5 of 10 titles individually tabled; the remainder follow the same pattern.
- Japanese documentation only; release dates for later titles are uncertain.

## Sources

Checked 2026-07-29.

- [Casio Loopy — Wikipedia](https://en.wikipedia.org/wiki/Casio_Loopy)
