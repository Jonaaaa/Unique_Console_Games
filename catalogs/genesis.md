...
Sega has re-released this library harder than any company in this repo: *Sega
...
third-party licensed work: Marvel's `X-Men` games, Acclaim's film tie-ins, and the
single most tangled case in the repo, `Michael Jackson's Moonwalker`.
...
- **32X (~40 titles).** Never included in any Sega collection. Structurally the most
