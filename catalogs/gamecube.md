# Nintendo GameCube — Unique Games Catalogue
...
## ⚠ This file will age faster than the others
...
**Why the GameCube strands games.** Uniquely in this repo, the answer for years was
...
3. **Competitive afterlife.** `Super Smash Bros. Melee` is the outlier — commercially
   valuable, legally unencumbered, and pointedly never re-released.
...
| The Legend of Zelda: Four Swords Adventures | 2004 | Nintendo EAD | Nintendo | Action-adventure | 1–4 | No | **Stranded** | — | Full multiplayer needs four GBAs and four link cables — arguably the most hardware-dependent setup Nintendo ever shipped. |
