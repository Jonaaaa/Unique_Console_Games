...
| Densetsu no Stafy | 2002 | Tose | Nintendo | Platformer | 1 | No | **Stranded** | — | Japan-only; the series only reached the West on DS. |
...
| Pokémon Emerald | 2004 | Game Freak | Nintendo | RPG | 1–2 | No | **Stranded** | — | The only third-version Pokémon game never remade or re-released. *Omega Ruby / Alpha Sapphire* remade Ruby and Sapphire and pointedly not this. |
...
| Drill Dozer | 2005 | **Include** (`Ported`) | The Wii U Virtual Console release is a genuine re-release on another platform. | The cartridge's rumble motor is central to the design and absent from the re-release, so what shipped elsewhere is arguably not the same game. |
