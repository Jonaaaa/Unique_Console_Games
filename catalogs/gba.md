...
| Sonic Battle | 2003 | Sonic Team | Sega | Fighting | 1–4 | No | **Stranded** |  |  | An isometric arena fighter with a character-customisation mode, unrelated to the `Advance` platformers it is filed alongside. Never collected. |
| Sonic Pinball Party | 2003 | Sonic Team | Sega | Pinball | 1–4 | No | **Stranded** |  |  | A pinball game with tables themed on `Sonic`, `NiGHTS` and `Samba de Amigo`. Its cross-series licensing is the likeliest reason it has never been reissued. |
...
| Mario Pinball Land | 2004 | Fuse Games | Nintendo | Pinball | 1 | No | **Stranded** |  |  | A pinball game where Mario is the ball, moving between tables as rooms. First-party and still never reissued, which makes it unusual among Nintendo's handheld output. |
