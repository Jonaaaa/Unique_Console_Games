...
| | |
|---|---|
| **Platform** | XaviXPORT (2004), XaviX Tennis / Bowling standalone units |
| **Lifespan** | 2004 – 2010; sales never disclosed |
| **Library size** | ~20 cartridges |
| **Backward compat** | None. |
| **Last verified** | 2026-07-29 |
| **Coverage** | Representative titles; the library is small and thinly documented. | ## ⚠ Motion control two years before the Wii
...
It launched in **2004, two years before the Wii**, and is the clearest commercial
precursor to motion-controlled console gaming. It sold poorly and SSD returned to
supplying chipsets for other companies' toys.
...
| — still `Stranded` | 5 |
| — since `Ported` | 0 |
| **Contested** | 0 | **Why XaviX strands games.** The peripheral *is* the game — each cartridge is inseparable
...
| XaviX Fishing | 2006 | SSD Company | SSD Company | Fishing | 1 | No | **Stranded** | | Shipped with a rod-and-reel controller featuring force feedback. | ## Excluded
...
| XaviX PowerBoxing standalone units | 2004–06 | Single-game plug-and-play versions of cartridges above. | ## Coverage gaps

- 5 of ~20 cartridges. Documentation is limited and largely Japanese.
- The chipset-licensee plug-and-play devices are characterised rather than catalogued.
