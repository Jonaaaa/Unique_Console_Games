...
| **Coverage** | Representative titles; the library is small and thinly documented. |
...
| XaviX Tennis | 2004 | SSD Company | SSD Company | Sports | 1–2 | No | **Stranded** | — | The launch title, bundled with a motion-sensing racket. Predates `Wii Sports` by two years and does essentially the same thing — the most historically significant entry on the platform, and completely unavailable. |
