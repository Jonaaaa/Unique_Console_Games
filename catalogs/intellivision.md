# Mattel Intellivision — Unique Games Catalogue
...
It is the earliest example in this repo of licensing-as-strategy becoming
licensing-as-tombstone — the same trap that later caught `Def Jam: Vendetta` and
`MLB The Show`.
...
the split here is unusually clean — Mattel's own games survived, licensed ones did not.
...
|---|---|---|
| Donkey Kong, Donkey Kong Junior | 1982–83 | Simultaneous home releases across Intellivision, 2600 and ColecoVision. |
