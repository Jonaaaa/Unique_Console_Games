# Sega Dreamcast — Unique Games Catalogue
...
- **Japan-only releases (~250 titles).** Visual novels, dating sims, and the deep
  ...
  Several of these are the only games in this repo released for a console its
  manufacturer had already abandoned.
- **VMU minigames.** The Visual Memory Unit was a memory card with a screen, a
  ...
  its battery. It is arguably the most thoroughly stranded software in this repo.
