...
| **Coverage** | First-party and major third-party titles verified individually. The licensed, casual and DSiWare tails are summarised, not enumerated — the DS has the largest shovelware tail of any platform in this repo. |
...
| Animal Crossing: Wild World | 2005 | Nintendo EAD | Nintendo | Life sim | 1–4 | Dead (2014) | **Stranded** | — | 11.75M sold. |
| Big Brain Academy | 2005 | Nintendo SPD | Nintendo | Edutainment | 1–8 | No | **Stranded** | — | The 2021 Switch entry is a new game. |
...
| Nintendogs | 2005 | Nintendo EAD | Nintendo | Pet sim | 1 | No | **Stranded** | — | 23.96M sold — the best-selling stranded game in this repo. Depends on the microphone for voice commands and the touchscreen for petting. |
...
| Jump Ultimate Stars | 2006 | Ganbarion | Nintendo | Fighting | 1–4 | No | **Stranded** | — | Japan-only. A crossover of ~40 Shonen Jump manga — the single most licence-locked game in this repo. |
| New Super Mario Bros. | 2006 | Nintendo EAD | Nintendo | Platformer | 1–2 | No | Ported | Wii U Virtual Console | 30.80M sold. |
| Pokémon Diamond and Pearl | 2006 | Game Freak | Nintendo | RPG | 1–4 | Dead (2014) | Ported | Switch (2021, *Brilliant Diamond / Shining Pearl* remakes) | |
| Apollo Justice: Ace Attorney | 2007 | Capcom | Capcom | Visual novel | 1 | No | Ported | iOS/Android, multiplatform (2024, *Apollo Justice Trilogy*) | |
| Chibi-Robo! Park Patrol | 2007 | Skip Ltd. | Nintendo | Action | 1 | No | **Stranded** | — | North America only. |
...
| Professor Layton and the Curious Village | 2007 | Level-5 | Level-5 | Puzzle adventure | 1 | No | Ported | iOS/Android (2018), Switch (2023, *HD*) | |
...
| Pokémon Platinum | 2008 | Game Freak | Nintendo | RPG | 1–4 | Dead (2014) | **Stranded** | — | *Brilliant Diamond / Shining Pearl* remade Diamond and Pearl and pointedly not Platinum, which is the definitive version of the generation. |
...
| Sands of Destruction | 2008 | Imageepoch | Sega | RPG | 1 | No | **Stranded** | — | Imageepoch went bankrupt in 2015. |
...
| Henry Hatsworth in the Puzzling Adventure | 2009 | EA Tiburon | EA | Platformer / puzzle | 1 | No | **Stranded** | — | Runs a platformer on the top screen and a match-3 on the bottom simultaneously — structurally unportable to one screen. |
...
| Ghost Trick: Phantom Detective | 2010 | Capcom | Capcom | Puzzle adventure | 1 | No | Ported | iOS (2012), multiplatform (2023 remaster) | |
...
- **DSiWare (~500 titles).** The DSi Shop closed in **2017**. Purchases cannot be
  ...
  thoroughly lost software in this repo, more so than Satellaview, because they
  were bought by ordinary customers who simply no longer have them.
- **Japan-only retail (~300 titles).** Includes `Jump Ultimate Stars`,
  `Soma Bringer` and a deep licensed-anime tail.

## Coverage gaps

- The casual/licensed tail is characterised, not enumerated — by far the largest
  uncatalogued block in this repo.
- DSiWare is not individually catalogued.
- There is **no NSO DS app**, so unlike the NES/SNES/N64/GBA files, `Ported` here
  is not expected to grow much. That makes DS `Stranded` claims unusually stable.
