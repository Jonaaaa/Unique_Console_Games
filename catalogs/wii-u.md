...
| Mario & Sonic at the Sochi 2014 Olympic Winter Games | 2013 | Sega | Nintendo | Sports | 1–4 | Dead (2024) | Stranded | — | The only entry in the series with **no** handheld counterpart — genuinely Wii U-only, unlike the Rio 2016 game. |
...
|---|---|---|---|---|
| Super Smash Bros. for Wii U | 2014 | **Include** | It is a separate build, not a version: different stages, different modes (8-Player Smash, Smash Tour), different engine target. Nothing named this exists on any other platform. | *Super Smash Bros. for Nintendo 3DS* shipped first (Sep 2014 JP) under the same product line, so the Wii U release is arguably the second half of one product rather than a debut. |
...
HTML5/JavaScript toolkit that made Wii U publishing unusually cheap. Almost none of
...
|---|---|---|---|
| **RCMADIAX** | 33 | **Stranded — high confidence** | Nintendo **denied RCMADIAX a Switch development licence in Feb 2018**. The entire catalogue is structurally locked to Wii U. |
