# Commodore Amiga CD32 — Unique Games Catalogue

| | |
|---|---|
| **Platform** | Commodore Amiga CD32 (1993) |
| **Lifespan** | Sep 1993 – 1994; ~100,000 units sold, Europe and Australia only |
...
## ⚠ This file is nearly empty, by rule
...
Commodore went bankrupt in **April 1994**, seven months after launch, which is why the
platform never developed software of its own.
...
|---|---|---|
| The great majority of the library (~180 titles) | 1993–94 | Amiga floppy originals reissued on CD — excluded on the same principle as PC-first games. Includes `Simon the Sorcerer`, `Beneath a Steel Sky`, `Zool 2`, `Alien Breed`, `Banshee`, `Superfrog`, `Cannon Fodder` and `Pinball Fantasies`. |
...
- **~180 are CD reissues of existing Amiga floppy games** — excluded, since the
  computer release came first.
- **~15 are multiplatform CD-ROM titles** that also shipped on PC, Sega CD or 3DO in
  the same window.
...
- Complete for identifiable debuts, but Amiga/CD32 release ordering in 1993–94 is
  thinly documented and a couple of calls could go either way.
- Commodore's bankruptcy means much of the paperwork that would settle those calls
  does not survive.
...
- [List of Amiga CD32 games — Wikipedia](https://en.wikipedia.org/wiki/List_of_Amiga_CD32_games)
- [Amiga CD32 — Wikipedia](https://en.wikipedia.org/wiki/Amiga_CD32) — sales and Commodore's bankruptcy
- [Microcosm — Wikipedia](https://en.wikipedia.org/wiki/Microcosm_(video_game))
