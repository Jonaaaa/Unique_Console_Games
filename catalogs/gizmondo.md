...
| **Coverage** | **Complete.** All 14 releases catalogued. | ## ⚠ The console that ended in criminal convictions
...
| — still `Stranded` | 5 |
| — since `Ported` | 0 |
| **Contested** | 0 | **Why the Gizmondo strands games.** Corporate collapse, comprehensively. There is no
...
| Trailblazer | 2005 | Warthog | Gizmondo Studios | Racing | 1 | No | **Stranded** | | A launch title, and a remake of a 1986 home computer game — included because this build was made for the Gizmondo, though the lineage weakens the claim. | ## Excluded
...
| *(games with a later mobile port)* | | Mobile is not a catalogued platform. | ## Coverage gaps
