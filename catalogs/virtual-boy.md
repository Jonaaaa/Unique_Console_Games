...
| **Library size** | **24 entries** — 21 commercially released plus 3 completed-but-unreleased. The smallest complete library in this repo. |
...
## ⚠ This file changed completely in 2026
...
**cardboard viewer** — the same trick as Nintendo Labo — which is the first time any
company has solved a stranded-hardware problem in this repo by manufacturing the
missing hardware again.
...
| Waterworld | 1995 | Ocean | Ocean | Action | 1 | No | **Stranded** | — | The Kevin Costner film licence, on a dead console, from a defunct publisher. Structurally the least reissuable game on the platform. |
