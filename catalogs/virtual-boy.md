...
| | |
|---|---|
| **Platform** | Nintendo Virtual Boy (1995) |
...
The Virtual Boy was the most thoroughly stranded platform in gaming history for
thirty years: a stereoscopic tabletop console with a red-on-black display that
nothing else could reproduce, 21 released games, and not one official re-release.
...
| Panic Bomber | 1995 | Hudson Soft | Nintendo | Puzzle | 1 | No | **Stranded** |  |  | Sold | JP: *Tobidase! Panibomb*. Konami absorbed Hudson, so the Bomberman rights now sit outside Nintendo, which is why it was skipped while other launch titles were not. |
| Red Alarm | 1995 | T&E Soft | Nintendo | Rail shooter | 1 | No | Ported | Switch 2 (2026, launch lineup) |  | Sold | Wireframe-only 3D: the purest demonstration of the hardware, and near-unreadable without it. |
| SD Gundam Dimension War | 1995 | Locomotive | Bandai | Tactical RPG | 1 | No | **Stranded** |  | Japanese | Sold | **The rarest Virtual Boy game.** Japan-only, tiny print run, and it needs the Bandai Gundam licence, which is why it was skipped alongside `Virtual Lab`. |
| Space Invaders: Virtual Collection | 1995 | Taito | Taito | Shoot 'em up | 1–2 | No | Ported | Switch 2 (2026, May update) | Japanese | Sold | Japan-only. A Taito title on a Nintendo service, which made it an unexpected inclusion. |
| Teleroboxer | 1995 | Nintendo R&D1 | Nintendo | Fighting | 1 | No | Ported | Switch 2 (2026, launch lineup) |  | Sold | The Japanese pack-in. First-person mech boxing built to demonstrate depth perception. |
| The Mansion of Innsmouth | 1995 | Be Top | I'Max | Adventure | 1 | No | Ported | Switch 2 (2026, launch lineup) | Japanese | Sold | JP: *Innsmouth no Yakata*. A Lovecraft-derived first-person horror game, Japan-only for 31 years; its 2026 release was its **first appearance outside Japan**. |
| Vertical Force | 1995 | Hudson Soft | Nintendo | Shoot 'em up | 1 | No | Ported | Switch 2 (2026, May update) |  | Sold | Uses two depth planes as separate flight altitudes. |
| Virtual Bowling | 1995 | Athena | Athena | Sports | 1 | No | Ported | Switch 2 (2026, May update) | Japanese | Sold | Japan-only, and one of the rarest Virtual Boy carts before the reissue. |
| Virtual Boy Wario Land | 1995 | Nintendo R&D1 | Nintendo | Platformer | 1 | No | Ported | Switch 2 (2026, launch lineup) |  | Sold | Universally regarded as the platform's best game, and the strongest single argument for the 2026 service. |
| Virtual Fishing | 1995 | Locomotive | Pack-In-Video | Fishing | 1 | No | **Stranded** |  | Japanese | Sold | Japan-only. Pack-In-Video was absorbed into Victor Interactive and then Marvelous, leaving no clear owner. |
...
| D-Hopper |  | Unknown | Nintendo | Unknown | 1 | No | Ported | Switch 2 (2026, August update) |  | Sold | ⚠ [Contested](#contested), likewise unreleased in 1995 and shipped alongside `Zero Racers` on 4 Aug 2026; same reasoning. |
| Zero Racers |  | Nintendo EAD | Nintendo | Racing | 1 | No | Ported | Switch 2 (2026, August update) |  | Sold | ⚠ [Contested](#contested): a completed F-Zero game cancelled in 1996, released for the first time on 4 Aug 2026, thirty years after it was built. Catalogued here because Virtual Boy is the hardware it was made for. |
...
- **Volatile by design.** The 2026 NSO lineup is still expanding. Two rare Japanese
 titles (`Virtual Lab`, `SD Gundam Dimension War`) and two licence-blocked ones
 (`Waterworld`, `Panic Bomber`) look like the durable holdouts, but that could change.
- The unreleased prototypes are recorded but their status is provisional, see
 [Contested](#contested).
- Unlike every other file here, **coverage is complete**: 22 of 22 games.

## Sources

Checked 2026-07-29.

- [List of Virtual Boy games (Wikipedia)](https://en.wikipedia.org/wiki/List_of_Virtual_Boy_games)
- [Virtual Boy – Nintendo Classics launch lineup revealed (Nintendo Everything)](https://nintendoeverything.com/virtual-boy-nintendo-classics-release-date-and-launch-lineup-revealed-for-nintendo-switch-2/)
