# 3DO Interactive Multiplayer — Unique Games Catalogue
...
building it — the only console in this repo with that model. It launched at $699,
...
| Policenauts | 1994 | Konami | Konami | Adventure | 1 | No | Ported | PS1, Saturn (1996) | Hideo Kojima's adventure game. Its 3DO release is the original; the console ports followed and were never localised either. |
...
| D | 1995 | Warp | Acclaim | Survival horror | 1 | No | Ported | PS1, Saturn, PC (1996) | Kenji Eno's debut. Unlike his later `Enemy Zero` and `D2` — both stranded — this one escaped because Acclaim published it widely. |
...
- **Full-motion-video titles (~60).** The 3DO's selling point was CD video, and a
  ...
  top of everything else. Structurally the least reissuable block.
