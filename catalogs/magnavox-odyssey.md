...
## ⚠ Why this file has one entry, not 28
...
`Stranded` in the most absolute sense in this repo: **no emulator can reproduce them
either**, because the missing part was never electronic.

Catalogued as one entry because splitting it into 28 rows would imply 28 pieces of
software, and there were none.
...
| Magnavox Odyssey² | 1978 | A separate, genuinely programmable console — see [Odyssey²](magnavox-odyssey-2.md). |
